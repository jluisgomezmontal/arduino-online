...
//////////////////////////////////////////////
const char SSID_ESP[] = "Vazgal";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "ibq13320058";             //Add the password of that WIFI connection
const char* host = "uhipocratesa19152245.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
String NOOBIX_id = "19152";                     //This is the ID you have on your database, I've used 99999 becuase there is a maximum of 5 characters
